    ...
    { expanded === "Projects" && <Suspense useFallback={null}><Projects handleClick={handleClick}></Projects></Suspense>}
      ...
      >
        ...
        <button
          ...
          className="text-gray-200 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-15 h-8 absolute top-2.5 end-2.5 flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white"
        >
          Back
