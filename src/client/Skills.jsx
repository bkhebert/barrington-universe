...
<div class="overflow-y-auto overflow-x-hidden z-10 fixed top-0 right-0 left-0 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-opacity-50 backdrop-blur-sm">
